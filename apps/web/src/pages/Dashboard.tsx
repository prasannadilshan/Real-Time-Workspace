...
import { FileText, Plus, LogOut, Search, Clock, Users } from 'lucide-react';
            ...
            {filteredDocs.map((doc) => (
              ...
              >
                <div className="absolute top-0 right-0 p-4 opacity-0 group-hover:opacity-100 transition-opacity">
                  <div className="bg-emerald-500/10 text-emerald-400 text-xs px-2 py-1 rounded-md ring-1 ring-emerald-500/20 font-medium">
                    Open
                  </div>
                </div>
                ...
                <div className="flex-1">
                  <div className="flex items-start gap-3 mb-3">
                    <div className={cn(
                      ...
                      doc.permissions.role === 'owner' ? "bg-blue-500/10 ring-blue-500/20 text-blue-400" : "bg-purple-500/10 ring-purple-500/20 text-purple-400"
                    )}>
                      {doc.permissions.role === 'owner' ? <FileText className="w-4 h-4" /> : <Users className="w-4 h-4" />}
                    </div>
